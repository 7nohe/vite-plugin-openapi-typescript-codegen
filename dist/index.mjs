...
var require_fsevents = __commonJS({
  "node-file:/Users/mikethompson/Desktop/vite-plugin-openapi-typescript-codegen-forked/node_modules/fsevents/fsevents.node"(exports, module) {
    init_fsevents();
    try {
...
function openApiTypescriptCodegen(options) {
  ...
  return {
    ...
    buildStart: async () => {
      var _a2;
      const OpenAPI = await import("./dist-HDABDRFB.mjs");
